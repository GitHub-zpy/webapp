//抽奖人员名单
var allPerson = "成明辉;陈绮曼;杜婉君;邝美红;梁玉婵;练金妍;刘绮瑶;栗文秀;尼佳平台;盘洁华;思创;思创;"+
"姚永坚;章伶丽;张闵;张永凤;赵浩宇";
//领导人员名单
var leaderArr = ["李董"];
//未中奖人员名单
...
$(function () {
    ...
    $("#btnStart").on("click", function () {
        ...
        if ($("#btnStart").text() === "开始") {
            ...
            if ($("#txtNum").val() > remainPerson.length) {
                showDialog("当前抽取人数大于业务总人数<br>当前抽取人数：<b>" + $("#txtNum").val() + "</b>人,业务总人数：<b>" + remainPerson.length + "</b>人");
                return false;
            }
            $("#result").fadeOut();
            //显示动画框，隐藏中奖框
            ...
            $("#txtNum").attr("placeholder", "输入抽取人数(" + remainPerson.length + ")");
        }
    });
    ...
    $("#btnReset").on("click", function () {
        ...
        showConfirm("确认重置吗？所有已抽取的人会重新回到抽取池！", function () {
            //熏置未中奖人员名单
            remainPerson = allPerson.toString().split(";");
            //中奖人数框置空
            $("#txtNum").val("").attr("placeholder", "请输入抽取人数");
            $("#showName").val("");
            //隐藏中奖名单,然后显示抽奖框
...
function startLuckDraw() {
    ...
    if (luckyDrawNum > remainPerson.length) {
        alert("抽取人数大于业务总人数！请修改人数。或者点重置开始将新一轮抽奖！");
        return false;
    }
    //随机中奖人
